...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, PARK1_LED_Pin|PARK2_LED_Pin|PARK3_LED_Pin|PARK4_LED_Pin
                          |PARK5_LED_Pin|GPIO_PIN_8, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PARK1_LED_Pin PARK2_LED_Pin PARK3_LED_Pin PARK4_LED_Pin
                           PARK5_LED_Pin PC8 */
  GPIO_InitStruct.Pin = PARK1_LED_Pin|PARK2_LED_Pin|PARK3_LED_Pin|PARK4_LED_Pin
                          |PARK5_LED_Pin|GPIO_PIN_8;
